...
</strong> Þifre : <strong><?php echo $_POST['adminpass']; ?>
</strong> Eklendi . <strong>Lütfen Bekleyiniz.</strong>
					</div>
				</div>
...
/icons/cross_grey_small.png" title="Close this notification" alt="close" /></a>
					<div align="center">
						...
						<br />
						Oyuncunun Admin Detaylarýný Düzenlemek Ýçin <a href="index.php?p=amxxeditadmin&action=amxxeditadmin_edit&id=<?php echo $this->_tpl_vars['admindetail']['id']; ?>
">Týklayýn</a>
						<br />
...
<?php endif; ?>" style="width:300px"></td>
		  ...
		  <tr class="bgacikmavi" onmouseout="this.className='bgacikmavi'" onmouseover="this.className='bgonmouseover'">
			...
			<input type="radio" name="yetki" <?php if (isset ( $_GET['plname'] )): ?>checked="checked"<?php endif; ?> value="abcdefghijkmnopqrstu" onclick="document.getElementById('ozelalan').style.display='none'"/> Normal Yöneticisi
